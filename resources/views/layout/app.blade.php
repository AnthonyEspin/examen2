...
<head>
    ...
    <!-- Google Maps -->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAwgyPfap_2pZcOlUrNAusGyC-k-Sf-ryM&callback=initMap&libraries=places"></script>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('clientes.create') }}">
                        <i class="bi bi-person-plus-fill"></i> Agregar circuito
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('predios/create') }}">
                        <i class="bi bi-map-fill"></i> Registrar 
                </li>
            </ul>
